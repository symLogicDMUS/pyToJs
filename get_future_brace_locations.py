...
from get_future_brace_location import get_closing_brace_location
from get_line_data import get_line_data


def get_closing_brace_locations(line_data, line_data_dict, cflc_indexs):
    """ """
    cb_locations = []
    for i in cflc_indexs:
        cb_locations.append(get_closing_brace_location(i, line_data_dict, line_data))
    return cb_locations
...
if __name__ == "__main__":
    ...
    cb_locations = get_closing_brace_locations(line_data, line_data_dict, cflc_indexs)
    pprint(cb_locations)
