...
def refactor_for_range(line_data):
    """ """
    for i in range(len(line_data)):
        if re.search(r'for \([a-zA-Z_][a-zA-Z0-9_]* in range\(len\((.*)\)\)\)',
                     line_data[i][2]) is not None:
            line = re.search(r'for \([a-zA-Z_][a-zA-Z0-9_]* in range\(len\((.*)\)\)\)',
                             line_data[i][2]).group()
            incrementer = re.search(r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(len\((.*)\)\)\)',
                                    line_data[i][2]).group(1)
            identifier = re.search(r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(len\((.*)\)\)\)',
                                   line_data[i][2]).group(2)
            line_data[i][2] = line_data[i][2].replace(line,
                                                      'for (let {} = 0; {} < {}.length; {}++)'.format(incrementer,
                                                                                                        incrementer,
                                                                                                        identifier,
                                                                                                        incrementer))
        elif re.search(r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(([0-9]+), len\((.*)\)\)\)',
                       line_data[i][2]) is not None:
            line = re.search(
                r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(([0-9]+), len\((.*)\)\)\)',
                line_data[i][2]).group()
            incrementer = re.search(
                r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(([0-9]+), len\((.*)\)\)\)',
                line_data[i][2]).group(1)
            start = re.search(
                r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(([0-9]+), len\((.*)\)\)\)',
            ...
            identifier = re.search(
                r'for \(([a-zA-Z_][a-zA-Z0-9_]*) in range\(([0-9]+), len\((.*)\)\)\)',
                line_data[i][2]).group(3)
            line_data[i][2] = line_data[i][2].replace(line,
                                                      'for (let {} = {}; {} < {}.length; {}++)'.format(incrementer,
                                                                                                         start,
                                                                                                         incrementer,
                                                                                                         identifier,
                                                                                                         incrementer))
