...
def refactor_identifiers(line_data, file_path, keyword='let'):
    """ """
    file_str = get_file_str(file_path, line_data)
...
if __name__ == "__main__":
    ...
    line_data, line_data_dict = refactor_identifiers(line_data,
                                                     '/home/brian/drafts/pyToJs/ckc-game-logic/fenParser/Fen.py')
