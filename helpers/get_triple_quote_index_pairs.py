...
def get_triple_quote_index_pairs(line_data):
    ...
    for line in line_data:
        if re.search(r'\s*"""', line[2]) is not None:
            t_quote = re.search(r'\s*"""', line[2]).group()
    ...
    if len(triple_quote_index_pairs) % 2 != 0:
        ...
        triple_quote_index_pairs = list(chunked(triple_quote_index_pairs, 2))
...
if __name__ == "__main__":
    ...
    print_list(get_triple_quote_index_pairs(line_data))