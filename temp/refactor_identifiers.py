...
from temp.get_file_str import get_file_str


def refactor_identifiers(blocks, keyword='let'):
    """ """
    file_str = get_file_str(blocks)
    matches = set(re.findall(r'([a-zA-Z_][a-zA-Z0-9_]*\s+=.*)', file_str))
    for match in matches:
        file_str = file_str.replace(match, keyword + " " + match + ";", 1)  # replace first instance
...
if __name__ == "__main__":
    ...
    pprint(refactor_identifiers(blocks))
