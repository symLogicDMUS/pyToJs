...
def get_indent_boundaries(cflc, len_ld):
    """ """
    indexs = list(map(lambda e: e[0], cflc))
    edge_pairs = list(chunked(indexs, 2))
    if len(edge_pairs[-1]) == 1:
        edge_pairs[-1].append(len_ld - 1)
    return edge_pairs
