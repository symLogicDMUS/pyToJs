def get_blocks(i, blocks, num_spaces, line_data):
    pass
    # """ """
    # block = {"lines": [], "child": {}}
    # while i != len(line_data) and (line_data[i][0] == num_spaces or blank_line(line_data[i])):
    #     block['lines'].append(line_data[i])
    #     i += 1
    # if block['lines']:
    #     blocks.append(block)
    # if i != len(line_data):
    #     # conditions are repeated because i changes when return from recursive call
    #     if line_data[i][0] > num_spaces:
    #         blocks, block['child'], i = get_blocks(i, blocks, line_data[i][0], line_data)
    #     else:
...
if __name__ == "__main__":
    ...
    # blocks, block_, i = get_blocks(i, blocks, num_spaces, line_data)
    # while i != len(line_data) and (line_data[i][0] >= num_spaces or blank_line(line_data[i])):
    #     if line_data[i][0] == num_spaces:
    #         block.extend(block_)
    #     elif line_data[i][0] > num_spaces:
    #         block['child'] = block
    #     blocks, block_, i = get_blocks(i, blocks, num_spaces, line_data)
    # # blocks, block, i = get_blocks(0, [], num_spaces, line_data)
    # pprint(blocks)
